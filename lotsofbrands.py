...
brand21 = Brands(user_id=1, name="BlogMutt", location="Boulder, CO", 
       description="No time? No writers? No blog posts? No problem. We are the simple, straightforward way to original blog content for your business or agency.", 
       industry=category7)
...
brand22 = Brands(user_id=1, name="iWriter", location="Carmel, IN", 
       description="iWriter is a marketplace to outsource your business' content writing needs.", 
       industry=category7)
...
brand23 = Brands(user_id=1, name="UpWork", location="San Francisco, CA", 
       description="Upwork, formerly Elance-oDesk, is a global freelancing platform where businesses and independent professionals connect and collaborate remotely.", 
       industry=category8)
...
brand24 = Brands(user_id=1, name="PeoplePerHour", location="London, UK", 
       description="PH is a community of talent available to work for you remotely, online, at a click of a button.", 
       industry=category8)
